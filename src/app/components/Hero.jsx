...
const Hero = () => {
  return (
    <section className='relative h-screen max-w-full flex flex-col items-center justify-start bg-white overflow-hidden'>
      ...
      <div className="relative z-10 mt-12 flex text-center justify-center items-center flex-col gap-4">
        <div className='w-[35%] flex gap-2 bg-white justify-center items-center p-2 rounded-full shadow-lg'>
          <div className='flex'>
            <img src="/img/pic1.png" alt="First image" />
            <img src="/img/pic2.png" alt="First image" />
            <img src="/img/pic3.png" alt="First image" />
          </div>
          <p className='font-semibold'>2.3k+ agencies sign up</p>
        </div>
        ...
        <div className='flex gap-2 mt-4'>
          <div className='flex gap-2 bg-blue px-1 py-0.5 md:px-6 md:py-3 rounded-full justify-center items-center'>
            <img src="/img/unlock.png" alt="Unlock icon" />
            <p className='text-white text-xs'>Start 14-Day Trial</p>
          </div>
          <div className='flex gap-2 border-2 border-gray-200 px-1 py-0.5 md:px-6 md:py-3 rounded-full justify-center items-center'>
            <img src="/img/play.png" alt="Play icon" />
            <p className='text-black-300 text-xs font-semibold'>Watch Product Demo</p>
          </div>
        </div>
      </div>
